...
exports.drugClassesDescription = void 0;
exports.drugClassesDescription = [
    {
        name: 'Analgesics',
    ...
    {
        name: 'Antibiotics',
        description: 'Drugs used to treat bacterial infections (e.g., Amoxicillin, Azithromycin)',
    },
    {
        name: 'Anticoagulants',
    ...
    {
        name: 'Antipsychotics',
        description: 'Used to treat psychiatric conditions (e.g., Olanzapine, Risperidone)',
    },
    {
        name: 'Bronchodilators',
        description: 'Used to treat respiratory issues like asthma (e.g., Albuterol, Salmeterol)',
    },
    {
        name: 'Corticosteroids',
        description: 'Used to reduce inflammation (e.g., Prednisone, Hydrocortisone)',
    },
    {
        name: 'Diuretics',
        description: 'Increase urine output (e.g., Furosemide, Hydrochlorothiazide)',
    },
    {
        name: 'Hormones',
    ...
    {
        name: 'Antivirals',
        description: 'Used to treat viral infections (e.g., Acyclovir, Oseltamivir)',
    },
    {
        name: 'Antifungals',
    ...
    {
        name: 'Antiemetics',
        description: 'Prevent nausea and vomiting (e.g., Ondansetron, Metoclopramide)',
    },
    {
        name: 'Anesthetics',
    ...
    },
    {
        ...
        description: 'Cancer chemotherapy drugs (e.g., Doxorubicin, Cyclophosphamide)',
    },
    {
        name: 'Antiparasitics',
    ...
    },
    {
        ...
        description: 'Modify immune responses (e.g., Interferons, Glatiramer acetate)',
    },
    {
    ...
    },
    {
        ...
        description: 'Facilitate mucus clearance (e.g., Guaifenesin, Acetylcysteine)',
    },
    {
        name: 'Gastrointestinal Agents',
        description: 'Proton pump inhibitors and H2-receptor antagonists (e.g., Omeprazole, Ranitidine)',
    },
    {
