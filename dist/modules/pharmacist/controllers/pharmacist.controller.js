...
let PharmacistController = class PharmacistController {
    ...
    async removeMedicine(walletAddress, productId, medicineId) {
    ...
    async updateMedicine(walletAddress, medicineId, productId, data) {
    ...
    async dispensePrescription(patientAddress, pharmacistAddress, dispenseDto) {
    ...
    async getMedicine(walletAddress, productId, medicineId) {
    ...
    async fetchProduct(walletAddress, productId) {
        return await this.pharmacistService.fetchProduct({
            walletAddress,
            productId,
        });
    }
    async getAllProducts(walletAddress) {
...
__decorate([
    ...
    (0, common_1.UseGuards)(pharmacist_auth_guard_1.PharmacistAuthGuard, pharmacist_auth_guard_1.PharmacistVerificationGuard),
    __param(0, (0, common_1.Query)('walletAddress', new common_1.ValidationPipe({ transform: true }))),
    __param(1, (0, common_1.Query)('productId', new common_1.ValidationPipe({ transform: true }))),
    __param(2, (0, common_1.Query)('medicineId', new common_1.ValidationPipe({ transform: true }))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, mongoose_1.Types.ObjectId, mongoose_1.Types.ObjectId]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, mongoose_1.Types.ObjectId, mongoose_1.Types.ObjectId, pharmacist_dto_1.UpdateMedicineDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, pharmacist_dto_1.DispenseMedicationDto]),
    __metadata("design:returntype", Promise)
